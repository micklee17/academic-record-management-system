...
public class StudentController {
        ...
        try {
            ...
            while (iterator.hasNext()){  //判断是否存在课程关联学生
                if(!selectedCourseService.isStudentId(iterator.next())){
                    ...
                    ajaxResult.setMessage("Unable to delete, there are associated students with the course.");
                    return ajaxResult;
                }
            }
            ...
            if(count > 0){
                ...
                ajaxResult.setMessage("All deletions successful.");
    ...
    public AjaxResult editStudent(@RequestParam("file") MultipartFile[] files,Student student){
        ...
        try{
            ...
            if(count > 0){
                ajaxResult.setSuccess(true);
                ajaxResult.setMessage("Modification successful.");
            }else{
                ajaxResult.setSuccess(false);
