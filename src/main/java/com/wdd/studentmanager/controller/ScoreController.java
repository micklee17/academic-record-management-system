...
public class ScoreController {
    ...
    public AjaxResult addScore(Score score){
        ...
        if(scoreService.isScore(score)){
            ...
            ajaxResult.setMessage("Already entered, please do not duplicate entries!");
        }else{
            int count = scoreService.addScore(score);
            if(count > 0){
                //签到成功
                ajaxResult.setSuccess(true);
                ajaxResult.setMessage("Entered successfully");
            }else{
                ajaxResult.setSuccess(false);
    ...
    public AjaxResult editScore(Score score){
        ...
        try {
            ...
            if(count > 0){
                ...
                ajaxResult.setSuccess(false);
                ajaxResult.setMessage("System error, please revise");
            }
        } catch (Exception e) {
            e.printStackTrace();
            ajaxResult.setSuccess(false);
        ...
        try {
            ...
            for(int rowNum = 1; rowNum <= sheetAt.getLastRowNum(); rowNum++){
                ...
                if(!scoreService.isScore(score)){
                    ...
                    errorMsg += "Line" + rowNum + "has already been entered and will not be repeated!\n";
                }
            }
            errorMsg += "Successfully entered" + count + "pieces of grade information!";
    ...
    private void exportScore(HttpServletResponse response,Score score,HttpSession session) {
        ...
        try {
            ...
            XSSFSheet createSheet = xssfWorkbook.createSheet("List of scores");
            ...
            createRow.createCell(3).setCellValue("Note");
            //实现将数据装入到excel文件中
            int row = 1;
    ...
    public Object getScoreStatsList(@RequestParam(value = "courseid", defaultValue = "0")Integer courseid,
        ...
        if(searchType.equals("avg")){
            ...
            avgStringList.add("Maximum score");
            avgStringList.add("Minimum score");
        ...
        rangeStringList.add("Below 60 points");
        rangeStringList.add("60~70 points");
        rangeStringList.add("70~80 points");
        rangeStringList.add("80~90 points");
        rangeStringList.add("90~100 points");
